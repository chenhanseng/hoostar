...
* @{
*/
#define PRODUCT_KEY "80f5a8f5e21d4d5c927b378146346f81"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "13542ad54ecb4b8bba3c1d12afb46157"
...
#define wendu_value_RATIO                         1
#define wendu_value_ADDITION                      -10
#define wendu_value_MIN                           0
#define wendu_value_MAX                           60
#define shidu_value_RATIO                         1
#define shidu_value_ADDITION                      0
#define shidu_value_MIN                           0
#define shidu_value_MAX                           100
#define V_value_RATIO                         1
#define V_value_ADDITION                      0
#define V_value_MIN                           0
#define V_value_MAX                           10
#define smoke_value_RATIO                         1
#define smoke_value_ADDITION                      0
#define smoke_value_MIN                           0
#define smoke_value_MAX                           4095
#define CO2_value_RATIO                         1
#define CO2_value_ADDITION                      0
#define CO2_value_MIN                           0
#define CO2_value_MAX                           4095
#define TVOC_value_RATIO                         1
#define TVOC_value_ADDITION                      0
#define TVOC_value_MIN                           0
#define TVOC_value_MAX                           4095
/**@} */
...
typedef struct {
  int32_t valuewendu_value;
  uint32_t valueshidu_value;
  float valueV_value;
  uint32_t valuesmoke_value;
  uint32_t valueCO2_value;
  uint32_t valueTVOC_value;
} dataPoint_t;
...
typedef struct {
  uint8_t valuewendu_value;
  uint8_t valueshidu_value;
  uint8_t valueV_value;
  uint16_t valuesmoke_value;
  uint16_t valueCO2_value;
  uint16_t valueTVOC_value;
} devStatus_t; 
